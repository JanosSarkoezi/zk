...
Der $k$-Vektorteil eines Multivektors aus dem $\mathscr{G}^n$ besteht nur aus
der Linearkombination der $k$-Blades. Wenn $A$ ein Multivektor ist dann wird
mit
$$\langle A\rangle_k$$
der $k$-Vektorteil bezeichnet.

Die Abbildung $\langle ...\rangle_k$ wird auch als Gradoperator genannt. Sie
...
- Sei ein $A$ ein Multivektor aus dem $\mathscr{G}^3$. Dann kann $A$ als Summe der
  ...
  $$A = \langle A\rangle_0 + \langle A\rangle_1 + \langle A\rangle_2 + \langle
  A\rangle_3$$
- Das geometische Produkt der Vektoren $u$ und $v$ kann auch in die
  ...
  wobei $\langle uv\rangle_0 = u \cdot v$, $\langle uv\rangle_1 = 0$ und 
