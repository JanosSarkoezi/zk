...
\begin{enumerate}
    ...
    \item \textbf{Konvergenzkriterium}: Eine Folge $(a_n)$ konvergiert (oder divergiert bestimmt gegen $\pm\infty$) genau dann, wenn $\liminf_{n \to \infty} a_n = \limsup_{n \to \infty} a_n$. In diesem Fall gilt:
