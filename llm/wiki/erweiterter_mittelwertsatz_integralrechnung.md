...
---
Es seien $f, g$ auf $[a, b]$ R-[[mittelwertsatz_integralrechnung|integrierbar]], $f$ stetig und $g$ ohne Vorzeichenwechsel (d.h. $g(x) \ge 0$ oder $g(x) \le 0$ für alle $x$). Dann gibt es eine Stelle $\xi \in [a, b]$ mit:
