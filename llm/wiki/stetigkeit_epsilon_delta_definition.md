...
---
Eine Funktion $f: X \to \mathbb{R}$ ist genau dann [[stetigkeit_folgen_definition|stetig]] in $\xi \in X$, wenn zu jedem $\epsilon > 0$ ein $\delta > 0$ existiert, so dass für alle $x \in X$ gilt:
