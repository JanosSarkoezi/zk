...
--proof--
Die Regel ist die Umkehrung der [[kettenregel|Kettenregel]] der Differentialrechnung. Ist $F$ eine Stammfunktion von $f$, so ist $F \circ g$ wegen der [[kettenregel|Kettenregel]] eine Stammfunktion von $(f \circ g) \cdot g'$. Die Behauptung folgt dann aus dem Hauptsatz.
