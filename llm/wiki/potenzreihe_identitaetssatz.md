...
---
Stimmen zwei [[potenzreihe_definition_konvergenz|Potenzreihen]] $f(x) = \sum a_n(x-x_0)^n$ und $g(x) = \sum b_n(x-x_0)^n$ in einer Umgebung von $x_0$ (oder in einer Menge mit Häufungspunkt $x_0$) überein, so sind sie identisch, d.h. es gilt
