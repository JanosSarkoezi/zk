...
Das **Darbouxsche Oberintegral** ist das [[supremum_infimum|Infimum]] aller Obersummen:
$$\overline{\int_a^b} f(x) \, dx = \inf_{Z} O(f, Z)$$
Eine Funktion heißt **D-[[riemann_integral_definition|integrierbar]]**, wenn Ober- und Unterintegral übereinstimmen.
