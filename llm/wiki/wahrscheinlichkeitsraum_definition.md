...
Eine messbare Abbildung $X: \Omega \to \Omega'$ in einen weiteren Messraum $(\Omega', \mathcal{F}')$ heißt **Zufallsvariable** (oder allgemeiner Zufallsgröße). Das Bildmaß $P_X = P \circ X^{-1}$ auf $\Omega'$ heißt die **Verteilung** von $X$.
