...
---
Sei $(a_n)$ eine monoton fallende Nullfolge reeller Zahlen mit $a_n \ge 0$. Dann konvergiert die alternierende [[reihe_definition|Reihe]]
...
Wegen $s_{2n+1} = s_{2n} - a_{2n+1} \le s_{2n}$ und $s_1 \le s_{2n+1} \le s_{2n} \le s_0$ sind beide [[monotoniekriterium|Folgen]] beschränkt und monoton, besitzen also nach dem [[monotoniekriterium|Monotoniekriterium]] Grenzwerte. 
