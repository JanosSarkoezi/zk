...
---
Eine reelle Funktion $f$ heißt auf einem Intervall $I$ **konvex**, wenn für je zwei verschiedene Punkte $x_1, x_2 \in I$ und für alle $\lambda \in (0,1)$ stets die [[jensen_ungleichung|Ungleichung]]
$$f((1-\lambda)x_1 + \lambda x_2) \le (1-\lambda)f(x_1) + \lambda f(x_2)$$
erfüllt ist. Gilt in dieser [[jensen_ungleichung|Ungleichung]] stets das Kleiner-Zeichen $<$, so heißt $f$ **streng konvex**.
...
Ist die umgekehrte [[jensen_ungleichung|Ungleichung]] erfüllt, heißt die Funktion **konkav** (bzw. **streng konkav**).
