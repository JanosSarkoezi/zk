...
---
Eine auf einer kompakten Menge $K$ [[stetigkeit_folgen_definition|stetige]] Funktion $f: K \to \mathbb{R}$ ist dort beschränkt und nimmt ihr Maximum sowie ihr Minimum an. Es gibt also $x_1, x_2 \in K$ mit:
