...
\begin{enumerate}[label=(\arabic*)]
  \item Eine Abbildung $f: \Omega \to \prod_{i \in I} \Omega_i$ ist genau dann messbar, wenn jede Koordinatenabbildung $f_i := \pi_i \circ f$ messbar ist ([[messbarkeit_produkt_raum_satz|Satz 3.3.2]]).
