...
---
Konvergiert die [[grenzwert_definition|Folge]] $(a_n)$ gegen $a$, so konvergiert auch die [[grenzwert_definition|Folge]] ihrer arithmetischen Mittel $(s_n)$ mit
...
Für $a \neq 0$ betrachte die [[grenzwert_definition|Folge]] $(a_n - a)$, die gegen 0 konvergiert. Die Linearität des Mittels liefert dann die Behauptung.
